...
- Map stress (amphibrach / trochee / iamb) onto the bar.
- Coach: Miss Little.
- Unlock: Baby Readarapper tier (about 50 percent lyric-swap readiness).

## 2. Alphabet Buss Down
Phonics on the beat. Letter name, letter sound, then CVC / blends.
- A-Z characters + hard/soft C and G toggles.
- Matching game + BeatLord scatter mode.
- Coach: Dr. Baby.
